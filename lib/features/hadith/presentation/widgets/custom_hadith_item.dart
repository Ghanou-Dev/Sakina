                    ...
                    onPressed: () async {
                      if (allSavedIds.contains(
                        ...
                        await context.read<SavedHadithCubit>().removeHadith(
                          hadith: SavedHadithEntity(
                            hadithArabic: widget.hadith.hadithArabic,
                            hadithEnglish: widget.hadith.hadithEnglish,
                            status: widget.hadith.status,
                            chapterArabic: widget.chapter.chapterArabic,
                            chapterEnglish: widget.chapter.chapterEnglish,
                            englishNarrator: widget.hadith.englishNarrator,
                            headingArabic: widget.hadith.headingArabic,
                            headingEnglish: widget.hadith.headingEnglish,
                          ),
                        );
                      } else {
